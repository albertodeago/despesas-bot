...
export type ReminderService = ReturnType<
  typeof initReminderService
>;
...
type ReminderServiceParams = {
  ...
  config: Pick<
    CONFIG_TYPE,
    'REMINDERS' | 'ADMINISTRATION_CHAT_ID'
  >;
  logger: Logger;
  bot: TelegramBot;
};
